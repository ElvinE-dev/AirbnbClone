...
export default function Perks({selected, onChange}){
    ...
    return(
        ...
        <div className="grid gap-2 grod-cols-2 md:grid-cols-4 lg:grid-cols-6">
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center'>
                <input type="checkbox" checked={selected.includes('parking')} name="parking" id="" onChange={handleClick}/>
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center'>
                <input type="checkbox" checked={selected.includes('radio')} name="radio" id="" onChange={handleClick}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center'>
                <input type="checkbox" name="pets" checked={selected.includes('pets')} id="" onChange={handleClick}/>
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center'>
                <input type="checkbox" name="entrance" checked={selected.includes('entrance')} id="" onChange={handleClick}/>
